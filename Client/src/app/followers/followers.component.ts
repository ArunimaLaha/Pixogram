...
export class FollowersComponent implements OnInit {
  ...
  constructor(
    ...
    this.http.post("http://localhost:6359/PixoGramSpring/follow/all", this.user)
      .subscribe((data: any) => {
  ...
  follow(follower: Followers) {
    ...
    this.http.post("http://localhost:6359/PixoGramSpring/follow/follow", follower)
  ...
  unfollow(follower: Followers) {
    ...
    this.http.post("http://localhost:6359/PixoGramSpring/follow/unfollow", follower)
      .subscribe((data: Followers) => {
        console.log(data);
      })
  }
