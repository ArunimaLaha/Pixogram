...
public class RegisterControllerTest {
	...
	public void registerUser() throws Exception
	{
		...
		mockUser.setUsername("Arunima Laha");
		mockUser.setFirstName("Arunima");
		mockUser.setLastName("Laha");
		mockUser.setEmail("aru@gmail.com");
		mockUser.setPassword("Arunima");
		mockUser.setProfilePicture("image");
		mockUser.setAbout("Wanderlust");
	...
	public void checkUsername() throws Exception
	{
		...
		mockUser1.setUsername("Arunima Laha");
		mockUser1.setFirstName("Arunima");
		mockUser1.setLastName("Laha");
		mockUser1.setEmail("aru@gmail.com");
		mockUser1.setPassword("Arunima");
		mockUser1.setProfilePicture("image");
		mockUser1.setAbout("Wanderlust");
